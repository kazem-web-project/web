                    ...
                    <div class="mb-3 datepickers">
                        <div class="d-flex justify-content-around">
                            <label for="start" id="datePickerStart" class="col-sm-2 col-form-label datePicker" >Start
                                date:</label>
                            <input name="from_date" type="date" name="trip-start" min="2022-10-01" max="2028-12-31" required>

                            <label for="start" id="datePickerEnd" class="col-sm-2 col-form-label datePicker">End
                                date:</label>
                            <input name="to_date" type="date" name="trip-start" min="2022-10-01" max="2028-12-31" required>
                        </div>
                    </div>
                    <!--end date picker -->
